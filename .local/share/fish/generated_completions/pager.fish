...
complete -c pager -l tilde -d 'Normally lines after end of file are displayed as a single tilde (\\(ti)'
...
complete -c pager -l header -d 'Sets the number of header lines and columns displayed on the screen'
complete -c pager -l incsearch -d 'Subsequent search commands will be "incremental"; that is,  less will advance…'
complete -c pager -l intr -d 'Use the character c instead of \\(haX to interrupt a read when the "Waiting fo…'
...
complete -c pager -l no-number-headers -d 'Header lines (defined via the --header option) are not assigned line numbers'
...
complete -c pager -l proc-backspace -d 'If set, backspaces are handled as if neither the -u option  nor the -U option…'
complete -c pager -l PROC-BACKSPACE -d 'If set, backspaces are handled as if the -U option were set; that is backspac…'
complete -c pager -l proc-return -d 'If set, carriage returns are handled as if neither the -u option  nor the -U …'
complete -c pager -l PROC-RETURN -d 'If set, carriage returns are handled as if the -U option were set; that is ca…'
complete -c pager -l proc-tab -d 'If set, tabs are handled as if the -U option were not set'
complete -c pager -l PROC-TAB -d 'If set, tabs are handled as if the -U option were set; that is tabs are treat…'
...
complete -c pager -l show-preproc-errors -d 'If a preprocessor produces data,  then exits with a non-zero exit code,  less…'
...
complete -c pager -l wordwrap -d 'When the -S option is not in use, wrap each line at a space or tab if possibl…'
...
complete -c pager -s ~ -d 'Normally lines after end of file are displayed as a single tilde (~)'
