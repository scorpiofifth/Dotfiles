...
complete -c pinentry-x11 -l display -l ttyname -l ttytype -l lc-ctype -l lc-messages -d 'These options are used to pass localization information to pinentry-gnome3'
