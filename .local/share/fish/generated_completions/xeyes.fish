...
complete -c xeyes -o biblicallyAccurate -d 'renders the eyes as if they belonged to a biblically accurate angel'
complete -c xeyes -o help -d 'print a usage message and exit'
complete -c xeyes -o version -d 'print the version number and exit'
